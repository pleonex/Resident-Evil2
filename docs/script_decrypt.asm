...
8047fecc  lis	r3, 0x8063
8047fed0  addi	r31, r3, 8480
8047fed4  addis	r16, r31, 1
8047fed8  li	r5, 8
...
804809ac  extsb	r5, r22           <-- Stop
804809b0  lwz	r4, 0x40F4 (r16)
804809b4  lwz	r6, 0x40F8 (r16)
804809b8  addi	r3, r6, 1           <--- HERE
804809bc  stw	r3, 0x40F8 (r16)
804809c0  stbx	r5, r4, r6
804809c4  rlwinm	r5, r22, 0, 24, 31 (000000ff)
804809c8  mr	r4, r23
804809cc  addi	r23, r23, 1
804809d0  addi	r3, r16, 240
804809d4  stbx	r5, r3, r4
804809d8  rlwinm	r23, r23, 0, 18, 31 (00003fff)
804809dc  b	->0x80480DAC
...
80480dac  lwz	r5, 0x002C (sp)
80480db0  addi	r3, r5, 1
80480db4  stw	r3, 0x002C (sp)
80480db8  lwz	r4, 0x002C (sp)
80480dbc  lwz	r3, 0x40F0 (r16)
80480dc0  cmplw	r4, r3
80480dc4  blt+	 ->0x8048083C
80480dc8  b	->0x80480468
80480dcc  addi	r11, sp, 128
80480dd0  bl	->0x80049DD8
80480dd4  lwz	r0, 0x0084 (sp)
80480dd8  mtlr	r0
80480ddc  addi	sp, sp, 128
80480de0  blr
